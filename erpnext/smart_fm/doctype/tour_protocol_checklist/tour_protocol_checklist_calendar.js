...
class TourCards{
	...
	setup_container(){
		this.container = $(`<div class="custom-calendar-container" id='tour-calendar'></div>`)
	...
	filter_service(service, remove=false){
		var me = this;
		var filters = [['Tour Protocol Checklist', 'service', '=', service]];
	...
	get_data(filters){
		return new Promise((resolve, reject) => {
			frappe.call({
				method:"erpnext.smart_fm.doctype.tour_protocol_checklist.tour_protocol_checklist.get_tour_list",
				args:{
					filters:filters
				},
				callback: r=>{

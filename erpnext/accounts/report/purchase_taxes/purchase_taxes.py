...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	for inv in invoice_list:
		...
		row.append((base_net_total or inv.base_net_total) if not inv.gst_input_tax else (inv.base_currency_of_base_value or inv.base_value))
...
def get_columns(invoice_list, additional_table_columns):
	...
	columns = [
		#_("Invoice") + ":Link/Purchase Invoice:120" + ":1",
		{
			"label": _("Invoice"),
			"fieldname": "invoice",
			"fieldtype": "Link",
		...
		{"label": _("Supplier Id"),   "width": 80, "hidden":1},
		#_("Supplier Id") + "::120:hidden/1",
		_("Supplier Name") + "::120",
	]
	...
	columns += [
		...
		#_("Tax Id") + "::80",
		{"label": _("Tax Id"),   "width": 80, "hidden":1},
		...
		#_("Bill No") + "::120",
		{"label": _("Bill No"),   "width": 100, "hidden":1},
		#_("Bill Date") + ":Date:80",
		{"label": _("Bill Date"),  "fieldtype": "Date", "width": 80, "hidden":1},
		#_("Remarks") + "::150",
		{"label": _("Remarks"),   "width": 150, "hidden":1},

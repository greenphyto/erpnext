...
frappe.query_reports["Trade Creditors"] = {
	"filters": [
		{
			"fieldname": "company",
			"label": __("Company"),
	...
	onload: function(report) {
		report.page.add_inner_button(__("Trade Creditors Summary"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Trade Creditors Summary', {company: filters.company});
		});
	}
}

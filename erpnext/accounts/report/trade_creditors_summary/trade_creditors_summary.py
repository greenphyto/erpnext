...
from erpnext.accounts.report.trade_creditors.trade_creditors import DebtorCreditorReport
...
class TradeCreditorsSummary(DebtorCreditorReport):
	def run(self, args):
	...
	def get_data(self, args):
		...
		self.receivables = DebtorCreditorReport(self.filters).run(args)[1]

...
// Load company theme CSS
if (frappe.boot.company_css_files && frappe.boot.company_css_files.length) {
  frappe.boot.company_css_files.forEach(function(css_path) {
    if (css_path && !document.querySelector(`link[href="${css_path}"]`)) {
      let link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = css_path;
      link.id = "company-theme-css";

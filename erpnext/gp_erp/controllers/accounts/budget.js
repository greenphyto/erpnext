...
frappe.ui.form.on('Budget Account', {
	january: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	february: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	march: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	april: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	may: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	june: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	july: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	august: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	september: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	october: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	november: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); },
	december: function(frm, cdt, cdn) { frm.cscript.calculate_total_row(frm, cdt, cdn); }
});

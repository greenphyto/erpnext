...
def get_default_cost_center(company, account=None):
	"""Returns the default cost center of the company, optionally considering account mapping"""
	if not company:
		return None

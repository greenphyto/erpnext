...
class Quotation(SellingController):
	...
	def get_existing_lead_from_new_customer(self):
		...
		lead_name = frappe.db.get_value("Lead", {"company_name": self.new_customer}, "name")
		if not lead_name:
			lead_name = frappe.db.get_value("Lead", {"lead_name": self.new_customer}, "name")
	...
	def _create_manual_contact_for_lead(self, lead_name):
		if not (self.manual_contact_person_name or self.manual_mobile_no or self.manual_tlp or self.manual_email):
			return

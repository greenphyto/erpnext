...
doc_events = {
	"*": {
		...
		"on_submit": "erpnext.smart_fm.controllers.smart_fm.close_todo",
		"on_cancel": "erpnext.smart_fm.controllers.smart_fm.close_todo",
		"validate": "erpnext.smart_fm.controllers.smart_fm.close_todo"    
	},
	"Stock Entry": {
...
scheduler_events = {
	...
	"daily": [
        ...
        "erpnext.smart_fm.doctype.tour_protocol_checklist.tour_protocol_checklist.send_email_notif"
	],
	"daily_long": [
